...
import { Upload, Download, RefreshCw, Image as ImageIcon, ArrowRight, FileImage, Minimize2 } from "lucide-react";
            ...
            <div className="container mx-auto px-4 pt-32 pb-24">
                <div className="text-center mb-12 animate-fade-in-up">
                    ...
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                        Optimize your images for the web. Resize, compress, and convert formats instantly.
                    </p>
                </div>
